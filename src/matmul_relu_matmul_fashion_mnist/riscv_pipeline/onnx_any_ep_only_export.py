...
parser = argparse.ArgumentParser(description="Export PyTorch MLP to ONNX with optional optimization based on JSON config.")
...
MODEL_PARAMS_PATH = config['dataset']['model_params_path']
ONNX_FP32_PATH = config['export_onnx']['onnx_fp32_path']
OPTIMIZED_ONNX_FP32_PATH = config['export_onnx']['optimized_onnx_fp32_path']
...
OPSET_VERSION = config['export_onnx']['opset_version']
